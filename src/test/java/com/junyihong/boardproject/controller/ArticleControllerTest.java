...
import com.junyihong.boardproject.service.ArticleService;
import com.junyihong.boardproject.service.PaginationService;
import com.junyihong.boardproject.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @WithMockUser // 인증된 가짜유저정보를 모킹해서 주입
    ...
    // 게시글 등록에는 실제 유저정보가 필요하기 때문에 WithMockUser 어노테이션 불가능
    // WithUserDetails는 실제로 등록되어있는 유저정보를 가져온다.
    // (TestSecurityConfig에서 junyihongTest를 등록했었음)
    @WithUserDetails(value = "junyihongTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
