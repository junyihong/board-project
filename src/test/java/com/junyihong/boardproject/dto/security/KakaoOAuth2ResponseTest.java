package com.junyihong.boardproject.dto.security;
...
class KakaoOAuth2ResponseTest {
    ...
    void givenMapFromJson_whenInstantiating_thenReturnsKakaoResponseObject() throws Exception {
        // Given """ 는 json 블럭을 표현하기 위한 것.
        String serializedResponse = """
                {
                    "id": 1234567890,
                    "connected_at": "2023-01-02T00:12:34Z",
                    "properties": {
                        "nickname": "홍길동"
                    },
                    "kakao_account": {
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("connectedAt", ZonedDateTime.of(2023, 1, 2, 0, 12, 34, 0, ZoneOffset.UTC)
