...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('junyihong', 'asdf1234', 'junyihong', 'junyihong@mail.com', 'I am junyihong.', now(), 'junyihong', now(),
        'junyihong')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('GoBatJun', 'asdf1234', 'GoBatJun', 'GoBatJun@mail.com', 'I am GoBatJun.', now(), 'GoBatJun', now(),
        'GoBatJun')
;
