...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('junyihong', 'asdf1234', 'junyihong', 'junyihong@naver.com', 'I am junyihong.', now(), 'junyihong', now(), 'junyihong')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('GobatJun', 'asdf1234', 'GobatJun', 'GobatJun@naver.com', 'I am GobatJun.', now(), 'GobatJun', now(), 'GobatJun')
;
