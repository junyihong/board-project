...
import com.junyihong.boardproject.dto.ArticleUpdateDto;
...
class ArticleServiceTest {
    ...
    @Test
    void givenSearchArticleId_whenSearchingArticle_thenReturnsArticle() {
        // Given
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        ...
        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "junyihong", "title", "content", "#java"));
